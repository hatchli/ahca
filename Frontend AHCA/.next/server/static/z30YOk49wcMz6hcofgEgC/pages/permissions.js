...
const Permissions = props => __jsx(external_react_apollo_["Query"], {
  ...
  return loading ? __jsx(external_react_default.a.Fragment, null, __jsx("h2", null, "Loading...")) : __jsx("div", null, __jsx(ErrorMessage["a" /* default */], {
    error: error
    ...
    key: permission
  }, permission)), "}", __jsx("th", null, "\uD83D\uDC47\uD83C\uDFFB"))), __jsx("tbody", null, users.map(user => __jsx(Permissions_UserPermissions, {
    user: user,
    key: user.id
  }))))));
});
...
class Permissions_UserPermissions extends external_react_default.a.Component {
  constructor(...args) {
    ...
    Object(defineProperty["a" /* default */])(this, "handlePermissionChange", e => {
...
const permissions = () => {
  return permissions_jsx("div", null, permissions_jsx(PleaseSignIn["a" /* default */], null, permissions_jsx(components_Permissions, null)));
};

/* harmony default export */ var pages_permissions = __webpack_exports__["default"] = (permissions);
